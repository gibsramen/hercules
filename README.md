...
A Docker image is available [here](https://hub.docker.com/repository/docker/gibsramen/hercules/general).
To run this, pull down the image and run the following:

```
docker run --platform linux/amd64 gibsramen/hercules:test python pyhercules.py
```
